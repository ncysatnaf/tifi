...
export function fetchChats() {
  return (dispatch) => {
    return fetch(`${baseURL}/api/chat/getChats`).
      then((response) => response.json()).
      then((response) => dispatch(addChat(response)))
  }
}
// export const fetchChats = async (dispatch) => {
//   let response = await fetch(`${baseURL}/chat/getChats`)
//   dispatch(addChats(response.json()))
// }
